...
public class TestGraph {
  public static void main(String[] args) {
    ...
    // List of Edge objects for graph in PPT slide 25
    //Class AbstractGraph.Edge is a class.
    //AbstractGraph.Edge class constructor is AbstractGraph.Edge(N from, N to)
    //There are two methods 1. N from() 2. N to()
    //from() returns the node this edge comes from
    //to() returns the node this edges goes to
    String[] names = {"Peter", "Jane", "Mark", "Cindy", "Wendy"};
    ArrayList<AbstractGraph.Edge> edgeList
      = new ArrayList<>();
